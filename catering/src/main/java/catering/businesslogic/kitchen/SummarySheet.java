...
public class SummarySheet {
    ...
    public SummarySheet(Service service, StaffMember staffMember) {

        this.service = service;
        this.owner = staffMember;
    ...
    public Assignment addAssignment(KitchenTask t, Shift s, StaffMember cook) {
        Assignment ass = new Assignment(t, s, cook);
        assignmentList.add(ass);
        return ass;
    }

    public boolean isOwner(StaffMember staffMember) {
        return staffMember.equals(this.owner);
    }
     ...
     * 
     * @return The StaffMember who owns this summary sheet
     */
