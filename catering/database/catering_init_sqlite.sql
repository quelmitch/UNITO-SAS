...
DROP TABLE IF EXISTS `StaffMemberRoles`;
...
DROP TABLE IF EXISTS `HolidayLeave`;
...
CREATE TABLE
    ...
    `employmentType_id` INTEGER NOT NULL,
    FOREIGN KEY (`employmentType_id`) REFERENCES `EmploymentTypes`(`id`)
);
...
CREATE TABLE
    `ShiftBookings` (
        ...
        `staff_member_id` INTEGER NOT NULL,
        PRIMARY KEY (`shift_id`, `staff_member_id`)
    );
...
CREATE TABLE
    `SummarySheets` (
        ...
        FOREIGN KEY (`owner_id`) REFERENCES `StaffMembers` (`id`)
    );
...
CREATE TABLE
    `Assignment` (
        ...
        FOREIGN KEY (`cook_id`) REFERENCES `StaffMembers` (`id`),
...
-- ===== ADD CUSTOM STAFF MEMBERS WITH ROLES =====
-- First, add staffMembers
INSERT INTO StaffMembers (email, name, surname, dateOfBirth, address, phone, wage, employmentType_id) VALUES
('marco.rossi@example.com', 'Marco', 'Rossi', '1992-03-15', 'Via Roma 10, Torino', '+393331234567', 1800, 0),
('giulia.bianchi@example.com', 'Giulia', 'Bianchi', '1995-07-22', 'Piazza Castello 5, Torino', '+393339876543', 1600, 0),
('luca.verdi@example.com', 'Luca', 'Verdi', '1988-11-01', 'Corso Vittorio Emanuele 20, Torino', '+393335554444', 2200, 0),
('sofia.gialli@example.com', 'Sofia', 'Gialli', '1990-04-20', 'Via Po 3, Torino', '+393331112233', 2000, 0),
('antonio.neri@example.com', 'Antonio', 'Neri', '1985-09-10', 'Via Garibaldi 1, Torino', '+393337778899', 2500, 1),
('chiara.bruni@example.com', 'Chiara', 'Bruni', '1993-01-05', 'Via Lagrange 12, Torino', '+393336667788', 2100, 1),
('giovanni.ricci@example.com', 'Giovanni', 'Ricci', '1980-06-30', 'Corso Francia 50, Torino', '+393332221100', 2300, 1),
('francesca.sarti@example.com', 'Francesca', 'Sarti', '1997-02-28', 'Via Cavour 7, Torino', '+393334445566', 1700, 1);
...
-- Next, set up the role entries in EmploymentTypes table (if not already present)
INSERT OR IGNORE INTO `EmploymentTypes` (`id`, `type_name`) VALUES
(0,'PERMANENTE'),
(1,'OCCASIONALE');

-- Now assign roles to staffMembers
-- Staff (SERVIZIO)
INSERT INTO StaffMemberRoles (staff_member_id, role_id, job) VALUES
(1, 3, 'Cameriere'),
(2, 3, 'Barista');
...
-- StaffMembers with multiple roles
INSERT INTO StaffMemberRoles (staff_member_id, role_id, job) VALUES
(5, 0, 'Aiuto Cuoco'),
(7, 3, 'Cameriere'),
(4, 3, 'Barista'),
